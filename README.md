...
This repository contains the **CreatorBrand** app: landing page with **waitlist**, **signup / login**, and creator/brand dashboards backed by a Node API and SQLite (Prisma).

**All application code is under `creatorbrand/`** (React client, Express API, Prisma). There is no second copy at the repo root.
